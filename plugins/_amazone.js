...
if (Config.WORKTYPE == 'private') {
    ...
    amazone.addCommand({pattern: 'thili ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    amazone.addCommand({pattern: 'pbot ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
...
async function checkImAdmin(message, user = message.client.user.jid) {
    ...
    return sonuc.includes(true);
     ...
     amazone.addCommand({pattern: 'pbot ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
